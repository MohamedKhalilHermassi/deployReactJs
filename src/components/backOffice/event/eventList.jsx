...
const EventList = () => {
    ...
    useEffect(() => {
      axios.get('https://deploynodejs-2.onrender.com/events')
        .then(response => {
    ...
    const handleDelete = (id) => {
        axios.delete(`https://deploynodejs-2.onrender.com/events/delete/${id}`)
        .then(() => {
        ...
        <div className="row">
          {currentEvents.map(event => (
            <div key={event._id} className="col-md-4 mb-4">
              ...
              <Card.Img variant="top" src={`https://deploynodejs-2.onrender.com${event.image}`} />
