...
const EditEvent = () => {
    ...
    useEffect(() => {
        axios.get(`https://deploynodejs-2.onrender.com/events/${id}`)
            .then(response => {
                if (response.data) {
    ...
    const handleSubmit = e => {
        ...
        axios.post('https://deploynodejs-2.onrender.com/upload', imageData)
            .then(response => {
                const data = { ...newFormData, image: response.data.imageUrl };

                return axios.put(`https://deploynodejs-2.onrender.com/events/edit/${id}`, data);
            })
            .then(response => {
