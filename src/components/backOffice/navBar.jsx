...
const NavBar = () => {
  ...
  useEffect(() => {
    ...
    fetchData();
    const socket = socketIOClient('https://deploynodejs-2.onrender.com/'); 
            ...
            <ul className="navbar-nav flex-row align-items-center ms-auto">
              ...
              <li className="nav-item navbar-dropdown dropdown-user dropdown">
                <a className="nav-link dropdown-toggle hide-arrow"  data-bs-toggle="dropdown">
                  ...
                  {userData ? (
                    <img src={`https://deploynodejs-2.onrender.com/${userData.image}`} alt="" className="w-px-40 h-auto rounded-circle" />
                    ) : (
                      <p>Loading...</p>
                    )}
                  </div>
