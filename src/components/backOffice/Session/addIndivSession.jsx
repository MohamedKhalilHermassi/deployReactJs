...
function CreateIndivSessions() {
    ...
    useEffect(() => {
        // Fetch student data
        fetch('https://deploynodejs-2.onrender.com/users/students')
        ...
        // Fetch course data
        fetch('https://deploynodejs-2.onrender.com/courses')
            .then(response => response.json())
            .then(data => {
    ...
    const handleCourseSelection = async (event) => {
        ...
        const response = await fetch(`https://deploynodejs-2.onrender.com/courses/${selectedId}`);
    ...
    const handleCreateSession = async () => {
        try {
            ...
            const responseSession = await fetch(`https://deploynodejs-2.onrender.com/users/match-available-time/${selectedStudentId}/${teacherid}`);
    ...
    const handleConfirmSession = async () => {
        try {
            ...
            const response = await fetch(`https://deploynodejs-2.onrender.com/sessions/addindiv/${selectedStudentId}/${teacherid}`, {
                method: 'POST',
                headers: {
