...
function SessionAdd() {
  ...
  const fetchCourses = async () => {
    try {
      const response = await fetch('https://deploynodejs-2.onrender.com/courses');
  ...
  const fetchTeachers = async () => {
    try {
      const response = await fetch('https://deploynodejs-2.onrender.com/users/teachers');
      const data = await response.json();
      setTeachers(data);
    } catch (error) {
  ...
  const fetchClassrooms = async () => {
    try {
      const response = await fetch('https://deploynodejs-2.onrender.com/classrooms');
      const data = await response.json();
      setClassrooms(data);
    } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://deploynodejs-2.onrender.com/sessions/add', {
        method: 'POST',
        headers: {
