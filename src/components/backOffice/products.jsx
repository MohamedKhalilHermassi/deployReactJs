...
function ProductListBack() {
  ...
  const handleAccept = async (productId) => {
    try {
      ...
      await axios.put(`https://deploynodejs-2.onrender.com/market/products/${productId}`, {
  ...
  const handleReject = async (productId) => {
    try {
      ...
      await axios.put(`https://deploynodejs-2.onrender.com/market/archiveProducts/${productId}`, { 
     archived: true
    },{
      headers: headers });
