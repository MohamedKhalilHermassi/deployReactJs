...
const PricingPack = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    if (Object.keys(validationErrors).length === 0) {
      try {
        const response = await fetch('https://deploynodejs-2.onrender.com/payement/pay', {
          method: 'PUT',
          headers: {
      ...
      try {
        const response = await axios.post('https://deploynodejs-2.onrender.com/transaction/add', formData); // Replace 'your-route' with your actual route
