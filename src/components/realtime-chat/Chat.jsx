...
const Chat = () => {
  ...
  const socket = io('https://deploynodejs-2.onrender.com'); // Replace with your server URL

  useEffect(() => {
    const fetchMessages = async () => {
      try {
        const response = await axios.get('https://deploynodejs-2.onrender.com/api/messages/get-all');
  ...
  const sendMessage = async () => {
    ...
    await axios.post('https://deploynodejs-2.onrender.com/api/messages/send-message', newMessage);
