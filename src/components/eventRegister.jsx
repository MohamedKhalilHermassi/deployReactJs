...
function EventRegister() {
    ...
    useEffect(() => {
        ...
        axios.get(`https://deploynodejs-2.onrender.com/events/${eventId}`).then(response => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.post('https://deploynodejs-2.onrender.com/events/register', data);
