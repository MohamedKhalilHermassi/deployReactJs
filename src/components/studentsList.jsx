...
function StudentsList() {
    ...
    useEffect(() => {
        const fetchCourse = async () => {
            try {
                const response = await axios.get(`https://deploynodejs-2.onrender.com/courses/${courseId}`);
    ...
    useEffect(() => {
        const fetchStudents = async () => {
            try {
                const response = await axios.get(`https://deploynodejs-2.onrender.com/courses/students-of-course/${courseId}`);
    ...
    const handleAddNote = async (studentId) => {
        try {
            await axios.put(`https://deploynodejs-2.onrender.com/courses/add-note/${studentId}`, { courseName, mark });
