...
{
  const BASE_URL =  'https://deploynodejs-2.onrender.com/Reclamtions'; 
                        ...
                        <div className="card">
                            <div className="card-body">
                                ...
                                {reclamation.files  && (
                                 ...
                                 <img src={`https://deploynodejs-2.onrender.com/${file}`} alt="Profile" className="img-fluid mb-3" style={{ width: '150px' }} />
                                  ))}
                                  </div>
                                )}
